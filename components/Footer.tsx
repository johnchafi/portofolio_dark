        ...
        <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
          ...
          <div className="flex items-center md:gap-3 gap-6 ">
            {socialMedia.map((info) => (
              <div
                key={info.id}
                className="bg-black w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300"
              >
                <Link className='cursor-pointer' href={info.link} target='_blank'>
